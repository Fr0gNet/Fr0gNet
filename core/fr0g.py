...
################Stellar Network configuration and utils#######################

TESTNET_PASSPHRASE = "Test SDF Network ; September 2015"
HORIZON_URL = "https://horizon-testnet.stellar.org"
NETWORK_ID = hashlib.sha256(TESTNET_PASSPHRASE.encode()).digest()
ENVELOPE_TYPE_TX         = b'\x00\x00\x00\x02'   # 2 = ENVELOPE_TYPE_TX
PUBLIC_KEY_TYPE_ED25519  = b'\x00\x00\x00\x00'   # 0
...
def sign_transaction(tx: Dict[str, Any], secret_seed: str) -> Dict[str, Any]:
    ...
    tx_body_xdr = (
        ...
        ops_xdr +
        struct.pack(">I", 0)   # FIX: Transaction.ext
    )
